...
const Skills = () => {
    ...
    return (
        <motion.div
            ...
            className='w-full xs:h-[200px] md:h-[240px] lg:h-[300px] bg-[#f6f6f6] rounded-lg shadow-lg shadow-black'>
            <div className='w-full h-fit bg-blue-300 px-4 py-1 rounded-t-lg'>
                <h1 className='text-white xs:text-sm lg:text-xl font-extrabold whitespace-new-line w-full'>
                    Skills
                </h1>
            </div>
            <div className='w-full xs:h-[160px] md:h-[200px] flex flex-col px-3 xs:gap-y-3 md:gap-y-4 items-center justify-center'>
