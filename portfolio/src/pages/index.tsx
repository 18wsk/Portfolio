        ...
        <div className='bg-white fixed w-screen h-screen overflow-scroll scrollbar-hide scroll-smooth md:scrollbar-default snap-mandatory snap-y'>
                                ...
                                <div className='w-full h-full grid grid-rows-4 gap-x-12 '>
                                    <div className='row-span-3 lg:w-max xs:w-screen h-full grid place-items-center lg:grid-cols-2 lg:gap-x-[32px]'>
                                        ...
                                        <div className='w-max h-max whitespace-pre-line '> 
                                            ...
                                            <h1 className='font-lato xs:pt-4 sm:pt-12 lg:pt-0 sm:text-6xl xs:text-5xl font-extrabold text-black underline decoration-my-blue'> William Kennedy</h1>
                                            <div className='flex flex-col items-center pt-4'>
                                                ...
                                                <div className='w-max xs:h-20 sm:h-40 flex items-center justify-center '>
                                                    <a className='shadow-md  drop-shadow-2xl shadow-my-blue/20 font-lato w-max h-10 bg-my-blue text-white rounded-lg m-4 px-4 flex items-center justify-center gap-x-2 font-bold hover:bg-blue-600' target="_blank" href={resume} download={resume.name} rel="noreferrer">{<AiOutlineDownload/>} Resume</a>
                                                </div>
                                                <Socials/>
                                            </div>
                                        </div>
            ...
            <PageSection>
                <div className='w-full h-full relative z-0 ' id="about" >
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className='w-full h-full items-center justify-center lg:pt-10 xs:pt-0 relative xs:hidden sm:hidden md:flex bg-white'
                    >
                        <div className='w-full h-full'>
                            <div className="w-full h-max xs:pt-4 lg:pt-0 justify-center ">
                                <h1 className='font-lato font-bold lg:text-[2rem] xs:text-xl text-center pb-4 custom_underline'>ABOUT ME</h1>
                            </div>
                            <Tab.Group>
                                <Tab.List className="w-full h-max flex items-center justify-center space-x-4 lg:py-10 xs:py-4">
                                    <Tab key={0} className={({ selected }) => (`border-2 rounded-full md:text-lg xs:text-sm shadow-xl outline-none ${selected && "border-blue-700 bg-my-blue text-white"} hover:border-blue-700`)}>
                                        <h1 className='font-lato text-center p-2'>Background</h1>
                                    </Tab>
                                    <Tab key={1} className={({ selected }) => (`border-2 rounded-full md:text-lg xs:text-sm shadow-xl outline-none ${selected && "border-blue-700 bg-my-blue text-white"} hover:border-blue-700`)}> 
                                        <h1 className='font-lato text-center p-2'>Hobbies</h1>
                                    </Tab>
                                </Tab.List>
                                <Tab.Panels className="h-full w-full flex">
                                    <Tab.Panel className='w-full h-full flex justify-center overflow-auto scrollbar-hide' key={0}>
                                        <motion.div
                                            ...
                                            viewport={{ once: true }}
                                            className='lg:w-2/3 lg:h-max xs:w-3/4 xs:h-2/3 rounded-xl md:shadow-2xl xs:shadow-md font-lato md:p-10 xs:p-4 bg-gray-50 md:text-2xl xs:text-md'
                                        > 
                    ...
                    >
                        <div className='w-full h-full'>
                            <div className="w-full h-max xs:pt-4 lg:pt-0  lg:flex justify-center">
                                <h1 className='font-lato font-bold lg:text-[4rem] xs:text-3xl text-center pb-4 decoration-my-blue underline underline-offset-8'>Skills</h1>
                            </div>
            ...
            <div className='w-full h-full relative z-0' id="experience" >
                    ...
                    >
                        <div className='w-full h-full'>
                            <div className="w-full h-max xs:pt-4 lg:pt-0 justify-center ">
                                <h1 className='font-lato font-bold lg:text-[4rem] xs:text-3xl text-center pb-4 decoration-my-blue underline underline-offset-8'>Experience</h1>
                            </div>
                            <Timeline/>
                        </div>
                    </motion.div>
            ...
            <div className='w-full h-full relative z-0' id="contact" >
                    ...
                    >
                        <div className='w-full h-full'>
                            <div className="w-full h-max xs:pt-4 lg:pt-0 justify-center ">
                                <h1 className='font-lato font-bold lg:text-[4rem] xs:text-3xl text-center pb-4 decoration-my-blue underline underline-offset-8'>Contact</h1>
                            </div>
                            <Contact/>
                        </div>
                    </motion.div>
